...
from jd_commoditydetail.settings import UA_list
...
from jd_commoditydetail.settings import CookiesList as cl
def Random_Cookies():
    '''cookies dict'''
    cookies_list = cl
    return random.choice(cookies_list)  #从当前cookie列表中随机返回一个cookie