...
class AimshopspiderDetailSpiderMiddleware(object):
...
class AimshopspiderDetailDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
...
class SeleniumFirefoxRenderAjaxDownloaderMiddleware(object):
    ...
    def process_request(self,request,spider):
        ...
        print('start request')
        flag = 0 #判断死循环跳出标志
        spider.driver.implicitly_wait(10) #隐式等待
        ...
        while True:
            ...
            if self.account in str(content): #条件
                ...
                # href = spider.driver.find_element_by_css_selector('a.sn-login').get_attribute('href')
                # spider.driver.get(href)
    ...
    def random_scroll_lenth(self):
        ...
        length = random.uniform(300,1500)
