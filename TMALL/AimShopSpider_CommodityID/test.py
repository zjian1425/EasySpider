...
UA_List = [
    ...
    'Media Center PC 6.0; .NET4.0C; .NET4.0E; LBBROWSER)',
...
conn = pymysql.connect('ip','NAME','PASSWORD','DB_NAME',charset='utf8')
cursor = conn.cursor()
do_query = """insert into 爬虫USERAGENT库(ua)values(%s)"""
for i in UA_List:
    try:
        cursor.execute(do_query,i)
        conn.commit()
