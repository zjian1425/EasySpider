...
"""https://loytio.tmall.com"""
"""python + selenium + webdriver render(javascript)"""

class Loytio(scrapy.Spider):
    
    name = 'Loytio'
    allowed_domains = ['tmall.com']
    start_urls = ['https://loytio.tmall.com/search.htm?&pageNo=1']
    ...
    def parse(self, response):
        for i in range(2,8):
            url = 'https://loytio.tmall.com/search.htm?&pageNo={0}'.format(i)
