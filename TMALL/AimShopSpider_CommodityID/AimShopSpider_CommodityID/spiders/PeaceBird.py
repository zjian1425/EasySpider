...
#     start_urls = ['https://pb89.tmall.com/search.htm?&orderType=hotsell_desc&pageNo=1']
#
#     """generation"""
#
#     def __init__(self):
...
#         for i in range(2, 21):
#             url = 'https://pb89.tmall.com/search.htm?&orderType=hotsell_desc&pageNo={0}'.format(i)
